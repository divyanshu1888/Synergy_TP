...
Electronics low_load (10 ohm), CV = 0.0051. Barely any spread between the 3 readings.



## Which replicate group is most noisy?

Mechanical high_load (150 N), CV = 0.1005 - highest of all 9 groups.



## Which group has the widest confidence interval?

Same group, Mechanical high_load: [1.41, 2.35]. About double the width of any other group.



## Which group has the highest coefficient of variation?

Same group: Mechanical, high_load, CV = 0.1005.
...
M009 (Mechanical, high_load, rep 3) - signal came in at 2.10 vs an expected 1.75, a 20% miss. It's the reason the whole high_load group got flagged moderate instead of stable. Worth re-checking before trusting that data point.
